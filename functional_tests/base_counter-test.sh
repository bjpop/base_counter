...
this_program_name="base_counter-test.sh"
...
${this_program_name}: run integration/regression tests for base_counter 

Usage:
    ${this_program_name} [-h] [-v] -p program -d test_data_dir 

Example:
    ${this_program_name} -p bin/base_counter -d data/tests
